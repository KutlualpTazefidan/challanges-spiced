...
// console.log(animalsSortedAlphabetically.map((animal) => animal.name));

const animalsSortedByWeightStartingWithLowest = animals
  .slice()
  .sort((a, b) => a.weight - b.weight);
// console.log(
// animalsSortedByWeightStartingWithLowest.map((animal) => animal.name)
// );
...
// console.log(animalsSortedByWeightReversed.map((animal) => animal.name));
...
const allAnimalsInEuropeWeighLessThanOnehundred = animals.filter(
  (animal) => animal.weight < 100 && animal.continents.includes("Europe")
);
// Test case wants a boolean
...
const weightOfAllAnimalsInAfrica = animals
  ...
  .reduce((a, b) => a + b);
// console.table(weightOfAllAnimalsInAfrica);
...
// console.table(averageWeightOfAllAnimalsInAfrica);
export {
